...
from utils.activations import FReLU, AFFactory
...
class DCGANDiscriminatorNet(nn.Module):
    ...
    def __init__(self, INPUT_CHN=3, DIS_FILTERS=64):
...
class DCGANGeneratorNet(nn.Module):
    ...
    def __init__(self, LATENT_DIM=128, GEN_FILTERS=64, INPUT_CHN=3):
...
class SNGANGeneratorNet(nn.Module):
    ...
    def __init__(self, BOTTOM_SIZE=4, GEN_FILTERS=64, INPUT_CHN=3, *args, **kwargs):
...
class SNGANDiscriminatorNet(nn.Module):
    ...
    def __init__(self, INPUT_CHN=3, DIS_FILTERS=64, *args, **kwargs):
